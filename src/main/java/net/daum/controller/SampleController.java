...
public class SampleController {
	...
	public ModelAndView start_thymeLeaf() {
		...
		tm.addObject("greeting", "안녕하세요. 타임리프");//greeting키이름에 문자 저장
		tm.setViewName("./thymeLeaf/start_thymeLeaf"); //뷰리졸브 경로는 /src/main/resources
		// /templates/thymeLeaf/start_thymeLeaf.html
		// /src/main/resources/static 경로에는 html,javascript,css,이미지 등 사이트개발에 필요한
		// 리소스 자원이 들어간다. STS상에서 .html, .css등을 만들면 자동으로 src/main/webapp 경로로 들어감
		return tm;
	}//start_thymeLeaf()
